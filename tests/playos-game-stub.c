...
#define PLAYOS_LIFECYCLE_FOREGROUND 0x00
#define PLAYOS_LIFECYCLE_BACKGROUND 0x01
#define PLAYOS_LIFECYCLE_SUSPEND    0x02
#define PLAYOS_LIFECYCLE_RESUME     0x03
#define PLAYOS_LIFECYCLE_TERMINATE  0x04
