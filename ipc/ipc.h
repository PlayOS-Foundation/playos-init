...
#define PLAYOS_IPC_TYPE_START_INSTALLER        "StartInstaller"
#define PLAYOS_IPC_TYPE_START_INSTALLER_ACK    "StartInstallerAck"
#define PLAYOS_IPC_TYPE_START_INSTALLER_ERROR  "StartInstallerError"
